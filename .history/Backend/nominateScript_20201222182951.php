...
if(isset($_POST['submit_button'])){
            ...
            if(in_array(${'fileActualExt' . $number}, ${'allowed' . $number})){
                if(${'fileError' . $number} === 0) {
                    ...
                    if (${'fileSize' . $number} < 5000000)/*5000000 = 5mb */{
                        ...
                        header("Location: ../Frontend/error.php?error=file_size>5MB");
                        exit();
                    }
                ...
                exit();*/
                header("Location: ../Frontend/error.php?error=wrong_file_type");
                exit();
            }
        }
    ...
    $fileNameNew1 = fileNameGenerator(1, "headshotNominee", "defaulthero.jpg", array('jpg', 'png', 'jpeg'));
    $fileNameNew2 = fileNameGenerator(2, "pic2Nominee", "defaultservice.jpeg", array('jpg', 'png', 'jpeg'));
    $fileNameNew3 = fileNameGenerator(3, "pic3Nominee", "defaultservice2.jpeg", array('jpg', 'png', 'jpeg'));
    $fileNameNew4 = fileNameGenerator(4, "resumeNominee", "", array('docx', 'pdf'));
