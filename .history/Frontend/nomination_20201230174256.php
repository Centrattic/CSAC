...
<main> 
    ...
    <link rel="shortcut icon" type="image/png" href="../Images/CSAClogo.png"/>
        ...
        <noscript><h3> You must have JavaScript enabled in order to use this form. Please 
            enable JavaScript and then reload this page in order to continue. </h3> 
            <meta HTTP-EQUIV="refresh" content=0;url="error.php?error=no-javascript"></noscript>
...
<!-- How many youth are you providing information about?-->
                ...
                <div class = "col-12">
                    ...
                    <input onkeypress="return myKeyPress(event)" class = "form-control" type="text" maxlength="80" id = "groupName" name="groupName" value="" title="Nominee's Full Name">
                </div>

                <div class = "form-row">
                    <div class = "col-6">
                        <label for = "nameNominee1">Nominee's Name * </label>
                        <input onkeypress="return myKeyPress(event)" class = "form-control" required type="text" id = "nameNominee1" name="nameNominee1" value="" title="Nominee's Full Name">
                    </div>

                    <div class = "col-5">
                        <label for="emailNominee1">Nominee's Email *</label>
                        <input onkeypress="return myKeyPress(event)" required class = "form-control" type="text" name="emailNominee1" value="" title="Nominee's Email">
                    </div>
                </div>
                ...
                <div class = "form-row">
                    <div class = "col-3">               
                        ...
                        <input onkeypress="return myKeyPress(event)" required class = "form-control" type="number" name="ageNominee1" min = "1" max = "18" value="" title="Nominee's Age"> <!-- add drop down for this-->
                    </div> <!-- JUST ADDED TODAY, DO PUT INTO DATABASE PROPERLY-->
         
                    <div class = "col-3">               
                        <label for="gradeNominee1">Nominee's Grade *</label>
                        <input onkeypress="return myKeyPress(event)" required class = "form-control" type="number" name="gradeNominee1" min = "1" max = "12" value="" title="Nominee's Grade"> <!-- add drop down for this-->
                        <!-- CHANGED UP GRADE WHEN PUT INTO DB, DO PUT INTO DATABASE PROPERLY-->
                    </div>

                    <div class = "col-5">
                        <label for="schoolNominee">Nominee's School Name *</label>
                        <input onkeypress="return myKeyPress(event)" required class = "form-control" id="schoolNominee" type="text" name="schoolNominee1" value="" title="Nominee's School Name">
        ...
        <fieldset>
            ...
            <i> This information will only be viewed by the Community Service Award Committee and will not be made public. </i> <br> <br>
                    <div class = "col-12">
                        ...
                        <input onkeypress="return myKeyPress(event)" class = "form-control" required type="text" id = "nameNominator" name="nameNominator" value="" title="Parent's Full Name">
                    </div>

                    <div class = "form-row">
                        <div class = "col-5">               
                            <label for="emailNominator">Nominator's Email *</label>
                            <input onkeypress="return myKeyPress(event)" class = "form-control" required type="text"name="emailNominator" value="" title="Parent's Email">
                        </div>

                        <div class = "col-6">               
                            <label for="phoneNominator">Nominator's Phone Number *</label>
                            <input onkeypress="return myKeyPress(event)" class = "form-control" required type="tel"name="phoneNominator" value="" title="Parent's Phone">
                        </div>
                    </div>  
        ...
        <fieldset>
            <legend> One Parental Contact </legend>
            ...
            <br> <br>
                    ...
                    <div class = "col-12">
                        ...
                        <input onkeypress="return myKeyPress(event)" class = "form-control" required type="text" id = "nameParent1" name="nameParent1" value="" title="Parent's Full Name">
                    </div>
                ...
                <div class = "form-row">
                    ...
                    <label for="emailParent1">Parent's Email *</label>
                        <input onkeypress="return myKeyPress(event)" class = "form-control" required type="text"name="emailParent1" value="" title="Parent's Email">
                    </div>

                    <div class = "col-6">               
                    <label for="phoneParent1">Parent's Phone Number *</label>
                        <input onkeypress="return myKeyPress(event)" class = "form-control" required type="tel"name="phoneParent1" value="" title="Parent's Phone">
                    </div>
                <div>
        </fieldset>
        ...
        <fieldset>
            ...
            <i> If your nominee is selected as a winner, this information may be used to promote the awards to the public. </i>
            <br> <br>
            <div>
                ...
                <div class="inputWrapper">
                    <textarea onkeypress="return myKeyPress(event)" class = "form-control" required maxlength="1500" name="workNominee" title="What work is the young hero/group doing?"></textarea>
        ...
        <fieldset> 
            ...
            <h4> Pictures </h4>
            <i> We encourage you to share photos of the work. Please upload them below along and include a short caption. We accept .jpg and .png formats. </i>
            <br>
